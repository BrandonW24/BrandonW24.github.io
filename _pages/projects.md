...
## Projects
Welcome to my project gallery. Below you will find a collection of my work, ranging from fully synchronized multiplayer VR environments to custom physics interactions and bridging hardware to digital spaces. 

Click on any project to read the full development breakdown!
...
<div class="project">
        <a href="{{ site.baseurl }}/projects/Runtime-Ragdoll-Fracture">
            ...
            <div class="project-content">
                ...
                <p style="font-weight: normal; font-size: 0.9em; color: #555;">A custom physics engine built with the Massive Loop SDK in Unity, featuring dynamic runtime player avatar cloning, auto-generated ragdoll joints + ragdoll physics, and procedural mesh slicing/CSG carving.</p>
            </div>
        </a>
    </div>    
